        ...
        <table class="mws-table mws-datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info"> 
         ...
         @foreach($admin as $row)
          <tr class="odd" align="center"> 
           ...
           <a href="/adminsrole/{{$row->id}}" class="btn btn-small del">分配角色</a>
            <a href="/admins/{{$row->id}}/edit" class="btn btn-small" title="修改"><i class="icon-pencil"></i></a>
            <form action="/admins/{{$row->id}}" method="post" style="display:inline;">
